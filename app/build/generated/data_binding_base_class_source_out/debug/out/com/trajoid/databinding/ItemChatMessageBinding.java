...
package com.trajoid.databinding;
...
public final class ItemChatMessageBinding implements ViewBinding {
  ...
  private ItemChatMessageBinding(@NonNull LinearLayout rootView, @NonNull TextView textMessage) {
  ...
  public static ItemChatMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatMessageBinding((LinearLayout) rootView, textMessage);
    }
